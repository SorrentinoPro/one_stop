...
<html lang="<?php echo $lang; ?>">
    <head>
		<title><?php echo $lang['PAGE_TITLE_404']; ?></title>
	    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/> <!--320-->
		<link href="<?php echo $mysite; ?>/errors/css/404.css"              rel="stylesheet">
    ...
    <body class="bk-404">
		...
		<div class="container">	
			<img class="poster" src="<?php echo $mysite; ?>/errors/img/404.gif">
		</div>
		
		<div class="menu">
		    <div class="resolve">
				<br><br><br><hr>
				<h2><?php echo $lang['HEADER_TITLE_404']; ?></h2>
				<hr><br>
				<h3><?php echo $lang['CONCERN']; ?>:</h3>
				<br>
				<p><?php echo $lang['MOTIVE_1_404']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_2_404']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_3_404']; ?></p>
				<br>
		...
		<div class="language">
		    <div class="resolve">
				...
				<hr><br>
				<div>
					<form name="ch_lang" action="<?php echo $mysite; ?>/errors/404.php" method="get">
