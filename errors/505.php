...
<html lang="<?php echo $lang; ?>">
    <head>
		<title><?php echo $lang['PAGE_TITLE_505']; ?></title>
	    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/> <!--320-->
		<link href="<?php echo $mysite; ?>/errors/css/505.css"              rel="stylesheet">
    ...
    <body class="bk-505">
		...
		<div class="container">	
			<img class="poster" src="<?php echo $mysite; ?>/errors/img/505.gif">
		</div>
		
		<div class="menu">
		    <div class="resolve">
				<br><br><br><hr>
				<h2><?php echo $lang['HEADER_TITLE_505']; ?></h2>
				<hr><br>
				<h3><?php echo $lang['CONCERN']; ?>:</h3>
				<br>
				<p><?php echo $lang['MOTIVE_1_505']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_2_505']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_3_505']; ?></p>
				<br>
		...
		<div class="language">
		    <div class="resolve">
				...
				<hr><br>
				<div>
					<form name="ch_lang" action="<?php echo $mysite; ?>/errors/505.php" method="get">
