...
<html lang="<?php echo $lang; ?>">
    <head>
		<title><?php echo $lang['PAGE_TITLE_304']; ?></title>
	    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/> <!--320-->
		<link href="<?php echo $mysite; ?>/errors/css/304.css"              rel="stylesheet">
    ...
    <body class="bk-304">
		...
		<div class="container">	
			<img class="poster" src="<?php echo $mysite; ?>/errors/img/304.gif">
		</div>
		
		<div class="menu">
		    <div class="resolve">
				<br><br><br><hr>
				<h2><?php echo $lang['HEADER_TITLE_304']; ?></h2>
				<hr><br>
				<h3><?php echo $lang['CONCERN_3']; ?>:</h3>
				<br>
				<p><?php echo $lang['MOTIVE_1_304']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_2_304']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_3_304']; ?></p>
				<br>
		...
		<div class="language">
		    <div class="resolve">
				...
				<hr><br>
				<div>
					<form name="ch_lang" action="<?php echo $mysite; ?>/errors/304.php" method="get">
