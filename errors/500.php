...
<html lang="<?php echo $lang; ?>">
    <head>
		<title><?php echo $lang['PAGE_TITLE_500']; ?></title>
	    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0"/> <!--320-->
		<link href="<?php echo $mysite; ?>/errors/css/500.css"              rel="stylesheet">
    ...
    <body class="bk-500">
		...
		<div class="container">	
			<img class="poster" src="<?php echo $mysite; ?>/errors/img/500.gif">
		</div>
		
		<div class="menu">
		    <div class="resolve">
				<br><br><br><hr>
				<h2><?php echo $lang['HEADER_TITLE_500']; ?></h2>
				<hr><br>
				<h3><?php echo $lang['CONCERN']; ?>:</h3>
				<br>
				<p><?php echo $lang['MOTIVE_1_500']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_2_500']; ?></p>
				<br>
				<p><?php echo $lang['MOTIVE_3_500']; ?></p>
				<br>
		...
		<div class="language">
		    <div class="resolve">
				...
				<hr><br>
				<div>
					<form name="ch_lang" action="<?php echo $mysite; ?>/errors/500.php" method="get">
